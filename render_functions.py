...
from menus import character_screen, body_screen, help_screen, inventory_menu, level_up_menu, magic_level_up_menu, scroll_menu
...
def render_all(con, panel, entities, player, game_map, fov_recompute, root_console, message_log,
    ...
    if game_state in (GameStates.SHOW_INVENTORY, GameStates.DROP_INVENTORY):
        if game_state == GameStates.SHOW_INVENTORY:
            ...
            inventory_title = 'Press the key next to an item to drop it, or Esc to cance.\n'
        ...
        body_screen(root_console, player, 60, 14, screen_width, screen_height)
